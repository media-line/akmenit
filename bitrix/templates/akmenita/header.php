...
<div class="main-top-block">
    <div class="top-block">
        <div class="wrapper wrapper-top">
            <header>
                <a target="_blank" href="https://www.instagram.com/flowers4u.minsk/">
                    <img class="icon" src="/bitrix/images/instagram-logo.svg"/>
                </a>
                <div class="top-phone">
...
<div class="popup popupdownload">
    <div class="popup_bg">
        <form action="" enctype="multipart/form-data" class="form-picking wrapper_narrow form formdownload"
              method="post">
            ...
            <div class="form-picking__inputs">
                ...
                <input class="form-picking__inputs_input" type="tel" placeholder="Ваш телефон" required name="phone">
                <textarea class="form-picking__inputs_input" placeholder="Ваш комментарий к букету" required
